                ...
                <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
                    <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg shadow-md">
                        <div className="flex items-center">
                            ...
                            <span className="ml-4 text-red-700 text-xl font-medium">{error}</span>
                        </div>
                        <div className="mt-4">
                            <button
                ...
                <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-2xl p-8">
                        ...
                        <div className="mt-4 sm:mt-0 w-full sm:w-1/3">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full py-3 px-4 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                                <svg className="h-6 w-6 text-gray-400 absolute left-4 top-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                        <div className="bg-blue-50 p-6 rounded-xl shadow-md">
                            <div className="text-lg text-gray-900 font-semibold">Total Messages</div>
                            <div className="text-4xl font-bold mt-3">{messages.length}</div>
                        </div>
                        <div className="bg-green-50 p-6 rounded-xl shadow-md">
                            <div className="text-lg text-green-800 font-semibold">New Messages (Last 7 Days)</div>
                        ...
                        <div className="bg-yellow-50 p-6 rounded-xl shadow-md">
                            <div className="text-lg text-yellow-800 font-semibold">Latest Message</div>
                        ...
                        <table className="min-w-full bg-white">
                            <thead>
                                <tr className="bg-blue-600 text-white">
                                    ...
                                    <th className="px-8 py-4 text-left font-semibold hidden md:table-cell">Date</th>
                                    <th className="px-8 py-4 text-left font-semibold">Subject</th>
                                ...
                                {filteredMessages.length > 0 ? (
                                    filteredMessages.map((message) => (
                                        <tr key={message.id} className="hover:bg-gray-100 transition-colors">
                                            <td className="px-8 py-4">{message.full_name}</td>
                                            <td className="px-8 py-4">
                                                <a href={`mailto:${message.email}`} className="text-blue-600 hover:underline">
                                                    {message.email}
                                                </a>
                                            </td>
                                            <td className="px-8 py-4 hidden md:table-cell">{formatDate(message.created_at)}</td>
                                            <td className="px-8 py-4">{message.subject}</td>
                                            <td className="px-8 py-4">
                                                <button
                                    ...
                                    <tr>
                                        <td colSpan="5" className="text-center px-8 py-10">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="mt-4 text-xl font-medium text-gray-600">No messages found.</span>
                                            </div>
                                        </td>
                                    </tr>
                                )}
                    ...
                    {filteredMessages.length > 0 && (
                        <div className="flex justify-center mt-8">
                            <nav className="flex items-center space-x-4">
                                <button className="px-6 py-3 rounded-md bg-gray-100 text-gray-600 hover:bg-gray-200">Previous</button>
                                <button className="px-4 py-3 rounded-md bg-[#727D73] text-white hover:bg-[#D0DDD0]">1</button>
                                <button className="px-6 py-3 rounded-md bg-gray-100 text-gray-600 hover:bg-gray-200">Next</button>
                            </nav>
                        </div>
                    )}
                            ...
                            <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full mx-4 max-h-screen overflow-y-auto">
                                <div className="p-8">
                                    <div className="flex justify-between items-center mb-8">
                                        <h3 className="text-3xl font-bold text-gray-900">Message Details</h3>
                                        <button
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <div className="text-xl font-semibold text-gray-900">{selectedMessage.full_name}</div>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            ...
                                            <div className="text-xl font-semibold">{formatDate(selectedMessage.created_at)}</div>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
                                            <div className="text-sm text-gray-500">Subject</div>
                                            <div className="text-xl font-semibold">{selectedMessage.subject}</div>
                                        </div>
                                        <div className="bg-gray-50 p-4 rounded-lg">
