...
const ProductDetailsModal = ({ product, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-md bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-800 mt-1">{product.description || 'No description provided'}</p>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-500">Category</p>
                    <p className="text-gray-800 mt-1">{product.category_name || 'Uncategorized'}</p>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-800 mt-1 capitalize">{product.delivery_type || 'Not specified'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Platform</p>
                    <p className="text-gray-800 mt-1 capitalize">{product.platform || 'Not specified'}</p>
                  </div>
                </div>

                <div>
                  <p className="text-sm text-gray-500">Product ID</p>
                  <p className="text-gray-800 mt-1 font-mono">{product.product_id}</p>
                </div>
              </div>
            </div>
          </div>
