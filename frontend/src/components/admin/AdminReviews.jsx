  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-lg transition ${showDeletedReviews ? 'bg-gray-200 text-gray-800' : 'bg-gray-800 text-white hover:bg-gray-700'
                }`}
            >
            ...
            <button
              ...
              className={`p-2 bg-blue-50 text-blue-600 rounded-lg shadow-sm hover:bg-blue-100 transition-colors ${isLoading ? 'animate-spin' : ''
                }`}
              disabled={isLoading}
        ...
        {/* Search and Filters */}
        <div className="bg-white shadow-lg rounded-xl overflow-hidden mb-4 sm:mb-8 border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <MessageSquareIcon className="absolute right-3 top-2.5 text-gray-400 w-4 h-4" />
                  {searchQuery && (
                    <button
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition appearance-none text-sm"
                  ...
                  <Star className="absolute right-3 top-2.5 text-gray-400 w-4 h-4" />
                </div>
              </div>
            </div>
            {(searchQuery || ratingFilter !== 'all') && (
              <div className="mt-4 flex justify-end">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-600 hover:text-gray-800 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
                >
                  <XIcon className="w-4 h-4" />
                  Clear filters
                </button>
        ...
        {/* Reviews List */}
        <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 mb-4 sm:mb-8">
          <div className="border-b border-gray-200">
            <div className="flex overflow-x-auto">
              <button
                ...
                className={`px-4 sm:px-6 py-3 sm:py-4 font-medium text-sm border-b-2 transition whitespace-nowrap ${!showDeletedReviews ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'
                  }`}
              >
              ...
              <>
                {reviews.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {reviews.map((review) => (
                      <div key={review.review_id} className={`border border-gray-200 rounded-lg p-4 sm:p-5 ${showDeletedReviews ? 'bg-gray-50' : 'hover:shadow-md'} transition`}>
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-3">
                          <div>
                            <div className="flex items-center gap-2 mb-2">
                              <PackageIcon className={`w-5 h-5 ${showDeletedReviews ? 'text-gray-500' : 'text-blue-500'}`} />
                              <h3 className={`text-base sm:text-lg font-bold ${showDeletedReviews ? 'text-gray-500 line-through' : 'text-gray-800'}`}>
                                {review.product_name}
                              </h3>
                            </div>
                        ...
                        <div className={`${showDeletedReviews ? 'bg-gray-100' : 'bg-gray-50'} p-3 sm:p-4 rounded-lg mb-3`}>
                          <p className={`text-sm sm:text-base ${showDeletedReviews ? 'text-gray-500' : 'text-gray-700'}`}>
                            {review.review_text}
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs sm:text-sm text-gray-500">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="truncate max-w-[200px]">{review.user_email}</span>
                            </div>
                          </div>
                ...
                {deletedReviews.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {deletedReviews.map((review) => (
                      <div key={review.review_id} className={`border border-gray-200 rounded-lg p-4 sm:p-5 bg-gray-50`}>
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-3">
                          <div>
                            <div className="flex items-center gap-2 mb-2">
                              <PackageIcon className={`w-5 h-5 text-gray-500`} />
                              <h3 className={`text-base sm:text-lg font-bold text-gray-500 line-through`}>
                                {review.product_name}
                              </h3>
                            </div>
                            <div className="flex items-center">
