...
const UsersAdmin = () => {
  ...
  const CustomPagination = ({ rowsPerPage, rowCount, onChangePage, onChangeRowsPerPage, currentPage }) => {
    ...
    const range = () => {
      const rangeSize = window.innerWidth < 640 ? 1 : 3;
      const pages = [];
    ...
    return (
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-4 sm:px-6 py-4 bg-white border-t border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-2">
          <div className="flex items-center w-full sm:w-auto">
            <label className="text-sm text-gray-600 mr-2 whitespace-nowrap">Rows per page:</label>
            <select
          ...
          <div className="flex items-center justify-center gap-1">
            <button
              className="p-1.5 rounded-md text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:hover:bg-white sm:hidden"
            ...
            <button
              className="p-1.5 rounded-md text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:hover:bg-white"
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center gap-2">
          ...
          <span
            className={`font-medium ${row.email_verified ? 'text-green-600' : 'text-red-600'
              }`}
          >
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className={`p-2 bg-blue-50 text-blue-600 rounded-lg shadow-sm 
                         hover:bg-blue-100 transition-colors ${isLoading ? 'animate-spin' : ''
