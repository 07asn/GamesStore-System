...
The 07ASN platform transitions an active social media-based business into a full-fledged e-commerce experience tailored to gamers. It provides a seamless shopping experience, easy navigation, and secure transactions for both digital and physical gaming products. The platform is developed using the **PERN Stack** and ensures responsive performance across all devices.
...
- **Admin Dashboard**:
  - Product management (add/edit/delete digital and physical items).
  - Order and customer management.
  - Analytics dashboard for tracking sales and growth.
...
- **Backend**:
  ...
  - Nodemailer (for email-based delivery)
...
- Expand growth potential with a scalable backend.
